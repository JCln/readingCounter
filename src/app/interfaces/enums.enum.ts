...
export enum EN_messages {
    ...
    insert_fatherName = 'نام پدر را وارد نمایید',
    ...
    uploadMaxCountForDetails = 'حجم فایل انتخابی از حداکثر حجم قابل ارسال(آپلود)',
    ...
    limitedLengthTitle = 'تعداد نویسه عنوان بیشتر از حد مجاز است',
    ...
    insert_commercialConstructionArea = 'عرصه تجاری را وارد نمایید',
    insert_domesticConstructionArea = 'عرصه را وارد نمایید',
    insert_otherConstructionArea = 'عرصه را وارد نمایید',
    ...
    insert_offering = 'شرح خدمت را وارد نمایید',
    ...
    insert_fromPostalCode = 'از کد پستی را وارد نمایید',
    insert_toPostalCode = 'تا کد پستی را وارد نمایید',
    insert_neighbourBillId = 'شناسه قبض همسایه را وارد نمایید',
    invalidFormat_neighbourBillId = 'فرمت شناسه قبض همسایه اشتباه است',
    invalidNumbers_neighbourBillId = 'ارقام شناسه قبض همسایه اشتباه است',
    ...
    insert_guild = 'صنف را وارد نمایید',
    ...
    insert_capacity = 'ظرفیت را وارد نمایید',
    ...
    insertـcustomerTyp = 'نوع مشترک را وارد نمایید',
    ...
    insert_ownershipType = 'نوع مالکیت را وارد نمایید',
    ...
    invalidPrice = 'فرمت مبلغ اشتباه است',
    invalidOffering = 'فرمت شرح خدمت اشتباه است',
    ...
    invalidLength_postalCode = 'تعداد ارقام کد پستی اشتباه است',
    format_fromPostalCode = 'فرمت از کد پستی اشتباه است',
    format_toPostalCode = 'فرمت تا کد پستی اشتباه است',
    ...
    wouldShowBigImageEnabled = 'بصورت خودکار، درصورت وجود یک تصویر در دیالوگ ها بزرگنمایی انجام خواهد شد',
    wouldShowBigImageDisabled = 'درصورت وجود یک تصویر در دیالوگ ها بزرگنمایی بصورت خودکار انجام نخواهد شد',
    ...
    isAfta = 'این بخش درحال توسعه می‌باشد',
    ...
    insertPrice = 'مبلغ را وارد نمایید',
    ...
    entityToo = 'حجم فایل انتخابی از مقدار مجاز',
...
export enum ENEssentialsToSave {
    ...
    offlineTextOut = 'offlineTextOut',
    offloadFormReq = 'offloadFormReq',
    fileUploadSingle = "fileUploadSingle",
    fileUploadSingleReq = "fileUploadSingleReq"
}
...
export enum ENLocalStorageNames {
    ...
    wouldShowBigImage = 'wouldShowBigImage',
