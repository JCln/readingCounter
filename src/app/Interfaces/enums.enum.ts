export enum EN_messages {
    ...
    insert_countryId = 'کد کشور را وارد نمایید',
    insert_provinceId = 'کد استان را وارد نمایید',
    insert_regionId = 'کد منطقه را وارد نمایید',
    insert_zoneId = 'کد ناحیه را وارد نمایید',
    ...
    confirm_userGroupChange = 'تا زمان ورود مجدد، کاربران گروه انتخابی امکان ادامه فعالیت را نخواهند داشت. آیا از ویرایش گروهی اطمینان دارید؟',
    confirm_userChange = 'تا زمان ورود مجدد، کاربر انتخابی امکان ادامه فعالیت را نخواهد داشت. آیا از ویرایش اطمینان دارید؟',
    confirm_passwordChange = 'تا زمان ورود مجدد، کاربر انتخابی امکان ادامه فعالیت را نخواهد داشت. آیا از تغییر گذرواژه اطمینان دارید؟',
