  ...
  private exactRoute = (currentRoute: string): IHelpWrapper => {
    ...
    if (currentRoute === '/wr/db')
      return {
        ...
        messageThree: 'عملکرد فرایند قرائت را در دو نمودار رادار و میله‌ای قابل مشاهده و بررسی هستند.',
      ...
      return {
        title: 'مدیریت نواحی',
        messageOne: 'این بخش برای مشاهده، شخصی سازی ، کنترل نواحی درنظر گرفته شده است.از قسمت های کشور، استان، مناطق، نواحی و محدوده ها تشکیل شده است بطوری که هر محدوده مربوط به یک ناحیه/شهر است. همچنین هر ناحیه/شهر مربوط به یک منطقه است. برای مثال مجموعه استان ها کشور را میسازند.',
        imgOne: 'assets/imgs/help/ARE.PNG',
        messageTwo: 'این بخش به این منظور درنظر گرفته شده است که بتوان بسادگی نواحی مختلف را درنظر گرفت. مثلا محدوده جدیدی را به یک ناحیه افزود',
