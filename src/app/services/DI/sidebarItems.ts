    ...
    addStaticSubRoutes: [
        {
            route: '', title: '', logicalOrder: 1, cssClass: '', isOpen: false, subItems: [
                ...
                { route: '/wr/rpts/exm/master/res', title: '-بازرسی', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/exm/details/res', title: '-جزئیات بازرسی', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/karkard/res', title: '-کارکرد', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/karkard/chart', title: 'چ_کارکرد', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/trv/res', title: '-پیمایش', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/karkardDaily/res', title: '-کارکرد روزانه', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/dh/res', title: '-پراکندگی ساعت', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/dh/chart', title: 'چ_پراکندگی ساعت', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/trvch/res', title: '-پیمایش تغییرات', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/mam/trvch/chart', title: 'چ_پیمایش تغییرات', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
                { route: '/wr/rpts/anlz/prfm/res', title: '-آنالیز عملکرد', isClosable: true, isRefreshable: false, cssClass: '', logicalOrder: 2 },
            ]
        }
        // {
