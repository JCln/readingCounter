...
export class ListManagerService {
  ...
  offloadModifyValidation = (object: IOffloadModifyReq): boolean => {
    ...
    if (MathS.isNull(object.counterNumber)) {
      this.utilsService.snackBarMessageWarn(EN_messages.format_invalid_counterNumber);
      return false;
    }
    // if (!MathS.isExactEqual(object.jalaliDay, 10)) {
