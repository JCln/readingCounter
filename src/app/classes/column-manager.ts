...
export class ColumnManager {
    ...
    rrPreNumber: IObjectIteratation[] = [
        ...
        { field: 'preDate', header: 'ت قبلی', isSelected: false, isSelectedOrigin: false },
        { field: 'offloadDateJalali', header: 'ت فعلی', isSelected: true, isSelectedOrigin: true },
        { field: 'preCounterStateCode', header: 'و قبلی', isSelected: false, isSelectedOrigin: false },
        // { field: 'counterStateCode', header: 'وضعیت فعلی(مشترکین)', isSelected: false,isSelectedOrigin:false },
        { field: 'counterStateId', header: 'و فعلی', isSelected: true, isSelectedOrigin: true },
        { field: 'address', header: 'آدرس', isSelected: false, isSelectedOrigin: false },
    ...
    listLatestInfo: IObjectIteratation[] =
        [
            ...
            { field: 'offloadDateJalali', header: 'ت فعلی', isSelected: true, isSelectedOrigin: true, readonly: true, tabIndex: -1 },
            { field: 'preDate', header: 'ت قبلی', isSelected: false, isSelectedOrigin: false, readonly: true, tabIndex: -1 },
    ...
    listLatestInfoAccordion: IObjectIteratation[] =
        [
            ...
            // { field: 'preCounterStateCode', header: 'و قبلی', isSelected: false,isSelectedOrigin:false ,readonly: tru,tabIndex:-1e},// if no zone insert number shows so PreCounterStateTitle implemented
    ...
    searchMosh: IObjectIteratation[] =
        [
            ...
            // { field: 'sifoonQotrCode', header: 'قطر سیفون', isSelected: false,isSelectedOrigin:false },
            { field: 'postalCode', header: 'کد پستی', isSelected: false, isSelectedOrigin: false },
            { field: 'preCounterStateTitle', header: 'و قبلی', isSelected: false, isSelectedOrigin: false },
            // { field: 'preCounterStateCode', header: 'و قبلی', isSelected: false,isSelectedOrigin:false },// if no zone insert number shows so PreCounterStateTitle implemented
            // { field: 'counterStateCode', header: 'وضعیت فعلی(مشترکین)', isSelected: false,isSelectedOrigin:false },
            { field: 'counterStateId', header: 'و فعلی', isSelected: true, isSelectedOrigin: true },
            { field: 'counterSerial', header: 'سریال کنتور', isSelected: false, isSelectedOrigin: false },
            { field: 'tavizDate', header: 'تاریخ تعویض', isSelected: false, isSelectedOrigin: false },
    ...
    generalListModify: IObjectIteratation[] = [
        ...
        { field: 'preDate', header: 'ت قبلی', isSelected: false, isSelectedOrigin: false, readonly: true },
        { field: 'offloadDateJalali', header: 'ت فعلی', isSelected: true, isSelectedOrigin: true, readonly: false },
        { field: 'preCounterStateCode', header: 'و قبلی', isSelected: false, isSelectedOrigin: false, readonly: true },
        // { field: 'counterStateCode', header: 'وضعیت فعلی(مشترکین)', isSelected: false,isSelectedOrigin:false, readonly: true },
        { field: 'counterStateId', header: 'و فعلی', isSelected: true, isSelectedOrigin: true, isSelectOption: true, readonly: false },
