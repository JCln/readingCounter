...
const routes: Routes = [
  ...
  { path: 'r', loadChildren: () => import('./read/read.module').then(read => read.ReadModule), data: { preload: true } },
  { path: 'track', loadChildren: () => import('./tracking/tracking.module').then(trackingManager => trackingManager.TrackingModule), data: { preload: true } },
  { path: 's', loadChildren: () => import('./search/search.module').then(searchManager => searchManager.SearchModule), data: { preload: true } },
  ...
  { path: 'l', loadChildren: () => import('./list-manager/list-manager.module').then(listManagerModule => listManagerModule.ListManagerModule), data: { preload: true } },
