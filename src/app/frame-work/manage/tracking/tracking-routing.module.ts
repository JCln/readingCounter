...
const routes: Routes = [
  ...
  { path: 'woui/:isForbidden/:UUID', loadChildren: () => import('./ab-dan-uploaded-info/ab-dan-uploaded-info.module').then(waterOfficerUploadedInfo => waterOfficerUploadedInfo.AbDanUploadedInfoModule) }
];
